...
#png(paste0(filename,"_genomecovplot.png"),height=800,width=1100)
...
png(paste0(filename,"_tssheatmap.png"),height=800,width=1100)
tagHeatmap(tagMatrix, xlim=c(-3000, 3000), color="red")
dev.off()

png(paste0(filename,"_tssfrequency.png"),height=800,width=1100)
...
write.csv(peakAnno@anno,file=paste0(filename,"_chipseeker_peakannotations.csv"))
